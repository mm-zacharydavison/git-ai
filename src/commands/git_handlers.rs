...
fn run_post_command_hooks(
    ...
    match parsed_args.command.as_deref() {
        ...
        Some("fetch") => fetch_hooks::fetch_post_command_hook(repository, parsed_args, exit_status),
        Some("pull") => fetch_hooks::fetch_post_command_hook(repository, parsed_args, exit_status),
