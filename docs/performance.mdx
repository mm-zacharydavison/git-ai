...
3. **Keep agents updated** - Newer versions of coding agents with the latest Git AI hooks will be most optimized. Run `git-ai install-hooks` to update your hooks.

### For Enterprise Deployments

1. **Monitor initial rollout** - Measure performance during pilot deployments
2. **Configure strategically** - Use repository allowlists to control where Git AI runs (see [Enterprise Configuration](https://usegitai.com/docs/enterprise-configuration))
...
2. Open an issue on the [GitHub repository](https://github.com/acunniffe/git-ai/issues)
