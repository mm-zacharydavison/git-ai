...
Create `$HOME/.git-ai/config.json` (or `%USERPROFILE%\.git-ai\config.json` on Windows) with your organization's settings. See [Enterprise Configuration](/enterprise-configuration) for details.
