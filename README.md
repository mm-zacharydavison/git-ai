...
To install (or update) `git-ai` run the install script that corresponds to your platform. The installation script will automatically setup everything you need.
